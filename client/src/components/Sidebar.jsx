      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
            ...
            <div className="relative py-2 group">
                ...
                <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#06050a] border border-gray-600 text-gray-100 hidden group-hover:block'>
        ...
        <div className='bg-[#06050a] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
    ...
    <div className='flex flex-col'>
        {filteredUsers.map((user, index)=>(
            <div onClick={()=> {setSelectedUser(user); setUnseenMessages(prev=> ({...prev, [user._id]:0}))}}
             key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#06050a]/50'}`}>
